...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Microsoft Tai Le", 22.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(192)), static_cast<System::Int32>(static_cast<System::Byte>(0)),
				static_cast<System::Int32>(static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(194, 30);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(274, 47);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Hello Instructor";
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(250, 239);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Tai Le", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(192)), static_cast<System::Int32>(static_cast<System::Byte>(0)),
				static_cast<System::Int32>(static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(46, 143);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(576, 38);
			this->label3->TabIndex = 14;
			this->label3->Text = L"Click on the button to Show the Schedule ";
			// 
			// MyForm11
			// 
			...
			this->ClientSize = System::Drawing::Size(710, 451);
