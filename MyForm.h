...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(244, 390);
			...
			this->label1->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(192)), static_cast<System::Int32>(static_cast<System::Byte>(0)),
				static_cast<System::Int32>(static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(161, 47);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(337, 35);
			this->label1->TabIndex = 1;
			this->label1->Text = L"Welcome to Miu Portal !";
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Tai Le", 16.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->label2->Size = System::Drawing::Size(312, 35);
			this->label2->TabIndex = 2;
			this->label2->Text = L"Please sign in to start :";
			// 
			// MyForm
			// 
